...
<View title="Python" icon="python">
  ...
  For async usage, call `await client.async_batch_post(url_path, payloads, preference, custom_headers, method)`.
</View>
...
<View title="JavaScript" icon="js">
  ...
  const preference = new RequestProcessingPreference(32, undefined, undefined, 360.0, 0.5);
